...
def hash_passwords(wordlist_path):
    ...
    try:
        # Define output files
        md5_file = r" " # Replace with your actual wordlist file path
        sha1_file = r" " # Replace with your actual wordlist file path
        sha256_file = r" " # Replace with your actual wordlist file path
...
# Example usage
wordlist_file = r" " # Replace with your actual wordlist file path
